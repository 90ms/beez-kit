...
1. Read repository `AGENTS.md`, `docs/architecture.md`, the affected module specifications, and [verification checklist](references/verification-checklist.md).
...
5. Run focused tests and lint, compile the catalog, inspect dependency graphs when relevant, and run the repository build when possible.
